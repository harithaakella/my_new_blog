...
$config['default_group']              = 'editor';           // Default group, use name
...
$config['error_start_delimiter']   = '<p class="text-danger"><strong><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> ';		// Error message start delimiter
